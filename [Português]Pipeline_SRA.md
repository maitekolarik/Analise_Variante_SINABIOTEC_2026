...
A partir de um accession de BioSample ou de amostra SRA (ex: `DRS309369`), encontre o(s) accession(s) de run associado(s):
...
5. Em "Output format" seelcione "BED" (ou a tabela estendida no estilo genePred, como usado abaixo)
